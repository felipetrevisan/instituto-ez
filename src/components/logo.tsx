  ...
  return (
    ...
    >
      ...
      <span className="flex flex-col justify-center">
        <p className="font-oswald text-primary-foreground text-lg font-bold">Instituto Ez</p>
        <p className="font-questrial text-primary-foreground text-sm font-light text-nowrap">Desenvolvimento Humano</p>
      </span>
    </motion.a>
  );
};
