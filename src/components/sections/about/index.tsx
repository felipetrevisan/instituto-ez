...
export function About() {
	...
	return (
		<div className="flex flex-col w-full gap-4">
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-none lg:[grid-template-areas:'left_right_right'] gap-4 w-full h-[900px] md:h-[500px] lg:h-[600px]">
				<div className="relative lg:[grid-area:left] w-full rounded-2xl overflow-hidden">
					<Image
				...
				{!isLoading && data && (
					<div className="relative lg:[grid-area:right] w-full rounded-2xl">
						...
						/>
						<div className="absolute flex flex-col text-secondary bg-white/80 md:bg-white h-max max-h-full w-[320px] md:w-[280px] -top-16 left-4 md:left-20 p-8 border-4 border-x-0 border-secondary gap-2 rounded-2xl backdrop-blur-lg md:backdrop-blur-none">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-none lg:[grid-template-areas:'left_left_left_right_right_right'] gap-4 w-full h-[900px] md:h-[500px] lg:h-[600px] mb-14">
				...
				{!isLoading && data && (
					<div className="relative lg:[grid-area:left] w-full rounded-2xl">
						...
						/>
						<div className="absolute flex flex-col text-secondary bg-white/80 md:bg-white h-max max-h-full w-[320px] md:w-[280px] bottom-12 md:-bottom-16 right-1/2 translate-x-1/2 lg:translate-x-0 lg:right-20 p-8 border-4 border-x-0 border-secondary gap-2 rounded-2xl backdrop-blur-lg md:backdrop-blur-none">
				...
				{!isLoading && data && (
					<div className="relative lg:[grid-area:right] w-full rounded-2xl">
						...
						/>
						<div className="absolute flex flex-col text-secondary bg-white/80 md:bg-white h-max max-h-full w-[320px] md:w-[280px] bottom-12 md:-bottom-16 lg:-top-28 right-1/2 translate-x-1/2 lg:translate-x-0 lg:right-72 p-8 border-4 border-x-0 border-secondary gap-2 rounded-2xl backdrop-blur-lg md:backdrop-blur-none">
