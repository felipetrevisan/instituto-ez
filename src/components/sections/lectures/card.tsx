    ...
    >
      ...
      <div
        className={cn(
          ...
          {
            "translate-x-1/2 right-1/2 md:right-0 xl:translate-x-0 xl:right-80": index % 2 == 0,
            "-translate-x-1/2 left-1/2 md:left-0 xl:translate-x-0 xl:left-80": index % 2 != 0,
          }
        )}
      >
        <div className="relative flex flex-col justify-start items-start w-full h-full text-primary-foreground p-10 gap-10">
          <h3 className="clamp-[xl-6cqw-4xl] text-center lg:text-left font-bold font-oswald">{title}</h3>
