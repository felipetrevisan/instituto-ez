...
export function TestimonialCard({ item, hoveredIndex, setHoveredIndex }: Props) {
    ...
    >
      <CardContent className="flex items-center justify-center w-ful p-0 h-full">
        <figure className="relative flex flex-col items-center justify-evenly w-full h-full border-0 py-0 px-8">
          <ScrollArea className="h-3/4 max-w-2xl mx-auto mb-4 lg:mb-8 text-base text-center lg:text-justify xl:text-center relative w-full">
