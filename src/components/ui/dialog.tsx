...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 text-center sm:text-left py-4 md:py-5 border-b rounded-t border-backgroud/30 ", className)}
      {...props}
    />
  )
}
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-2xl text-primary leading-none font-semibold", className)}
      {...props}
    />
  )
}
