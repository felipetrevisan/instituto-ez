  ...
  return (
    <div className="flex flex-col gap-10">
        ...
        >
          <div className="relative container flex h-full p-20 my-20">
            <div className="flex flex-col gap-10 justify-center items-center font-bold font-oswald w-full text-white">
              <h3 className="clamp-[xl-6cqw-6xl] absolute top-1">{background.title}</h3>
              <div className="aspect-video overflow-hidden rounded-2xl shadow max-h-[300px] max-w-[400px] h-[300px]">
                <ReactPlayer
                  url={video.url}
                  width="60vw"
                  height="100%"
      ...
      <div className="container flex flex-col gap-10 justify-center items-center">
        <App.Title className="clamp-[xl-6cqw-6xl] text-center">{title}</App.Title>
