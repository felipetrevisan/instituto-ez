...
export function SectionContent({
  ...
  return (
    <div className="flex flex-col gap-10">
        ...
        >
          {media.type === 'IMAGE' && media.image ? (
            ...
            <div className="relative flex h-full">
              <div className="flex w-full flex-col items-center justify-center gap-10 font-bold font-oswald text-white">
                <div className="h-[300px] w-[90vw] max-w-full overflow-hidden rounded-2xl shadow md:h-[440px] md:w-[70vw] lg:m-[100px] lg:h-[480px] lg:w-[50vw]">
                  <ReactPlayer
                    config={{
                      youtube: {
                        playerVars: {
      ...
      <div
        className={cn('container flex max-w-8xl flex-col items-center justify-center gap-10', {
          'w-screen xl:w-[65vw]': slug !== 'ebooks',
          'w-screen': slug === 'ebooks',
        })}
      >
        {title?.[locale] && <Title className="text-center">{title?.[locale]}</Title>}
        <div
          className={cn(
