...
const ctaField = `
  "cta": select(
    _type == "webnario.hero" || _type == "webnario.finalCta" => cta[] {
      ...,
      ${buttonFields}
    },
    cta {
...
export const webinarQuery = groq`
  *[ _type == "webnario" && enabled == true ] | order(orderRank) {
    ${fields}
    ${cardField}
  }
`

export const webinarQueryBySlug = groq`
  *[ _type == "webnario" && slug[$locale].current == $slug && enabled == true ] [0] {
    ${fields}
    ${seoField}
    ${cardField}
    sections[] {
      ...
      _type == "webnario.finalCta" => {
        ...,
        "image": image {
          ${imageField}
        }
      },
      _type == "webnario.expert" => {
        ...,
        "experts": experts[] {
          ...,
          "photo": photo {
