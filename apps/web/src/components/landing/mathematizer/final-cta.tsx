          ...
          <div className="mx-auto max-w-4xl space-y-8 text-center">
            ...
            <div className="space-y-6 text-foreground/90 text-lg leading-relaxed">
              <p>
                ...
                . Sem essa clareza, qualquer estratégia se transforma em tentativa, e tentar custa caro
              </p>

              <p>
              O Matematizador é o divisor entre administrar por instinto e liderar com ciência. Ele transforma percepções em dados objetivos e entrega a precisão necessária para mostrar exatamente onde agir para multiplicar resultados.
              </p>
            ...
            <div className="space-y-4 pt-8">
              ...
              Aplicações limitadas por trimestre. Prioridade para organizações que valorizam métricas, precisão e resultados mensuráveis.
              </p>
            </div>
          </div>
        </div>
