...
export const Diagnostic = ({
  ...
  return (
    <StickySection className="bg-card py-16 sm:py-20" id="diagnostics">
                ...
                {data.items.length > 0 && (
                  <div className="space-y-4">
                    {data.items.map((item, index) => {
                      ...
                      return (
                        <motion.div
                          className={cn('flex items-start gap-4 rounded-lg p-6 transition-colors', {
                        ...
                        >
                          ...
                          <div>
                            <h3 className="font-semibold text-foreground">{item.title[locale]}</h3>
                          </div>
                        </motion.div>
                      )
                    })}
