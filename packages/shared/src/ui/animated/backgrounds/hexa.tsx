            ...
            {Array.from({ length: gridDimensions.columns }).map((_, colIndex) => (
              <div
                ...
                className={cn(
                  ...
                  "before:absolute before:top-0 before:left-0 before:h-full before:w-full before:bg-white before:opacity-100 before:transition-all before:duration-1000 before:content-['']",
                  "after:absolute after:inset-[var(--hexagon-margin)] after:bg-white after:content-['']",
                  'after:[clip-path:polygon(50%_0%,_100%_25%,_100%_75%,_50%_100%,_0%_75%,_0%_25%)]',
                  'hover:after:bg-neutral-100 hover:after:opacity-100 hover:after:duration-0 hover:before:bg-neutral-200 hover:before:opacity-100 hover:before:duration-0',
